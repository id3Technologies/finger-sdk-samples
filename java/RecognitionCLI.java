...
public class RecognitionCLI {
    ...
    public static void main(String[] args) {
        ...
        FingerLibrary.loadModel(modelPath, FingerModel.FINGER_ALIGNER_1A, ProcessingUnit.CPU); // optional if using proprietary data
        FingerLibrary.loadModel(modelPath, FingerModel.FINGER_ENCODER_1A, ProcessingUnit.CPU); // optional if using proprietary data
        ...
        fingerExtractor.setMinutiaDetectorModel(FingerModel.FINGER_MINUTIA_DETECTOR_3B); // activate minutiae detection (mandatory)
        fingerExtractor.setFingerAlignerModel(FingerModel.FINGER_ALIGNER_1A); // activate alignment for finger encoding (optional)
        fingerExtractor.setFingerEncoderModel(FingerModel.FINGER_ENCODER_1A); // activate proprietary template encoding (optional)
